          ...
          <Fragment>
            ...
            <div id="app-container">
              ...
              <main className={classes.main}>
                ...
                {this.state.selectedId !== null && this.state.dialogAddFavouriteOpen && <DialogAddFavourite opened={this.state.dialogAddFavouriteOpen} onClose={this.onHideAddFavouriteDialog} syncKey={this.state.syncKey} userData={this.state.userData} chipId={this.state.selectedId} />}
                {this.state.selected !== null && this.state.dialogSensorDataOpen && <DialogSensorData opened={this.state.dialogSensorDataOpen} onClose={this.onHideSensorDataDialog} onOpenDetails={this.onShowDetailsDialog} sensor={this.state.selected} />}
